...
const LocationIcon: React.FC<LocationIconProps> = ({ onClick, className }) => {
    ...
    return (
        <button
            type="button"
            onClick={handleClick}
            className={`p-2 rounded-md bg-white hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 shadow-md focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors ${className || ''}`}
